<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChildPassengerDetails.ascx.cs" Inherits="UIA_WebApp.ChildPassengerDetails" EnableViewState="false"%>
<style type="text/css">
    .auto-style1 {
        height: 23px;
        text-align: left;
...
<table style="table-layout: fixed">
            <tr>
                <td class="auto-style1" colspan="3">
                    ...
                    <asp:Label ID="ChildNoLabel1" runat="server" Text="Type #"></asp:Label>
                    </h3>
                    </td>
            </tr>
            <tr>
                <td style="width: 294px" class="auto-style2"><strong>Title<br />
                </strong>
            ...
            <tr>
                <td class="auto-style3"><strong>First Name<br />
                </strong>
            ...
            <tr>
                <td class="auto-style3"><strong>Last Name</strong><br />
                ...
                <td class="auto-style2" style="width: 595px">
                    <asp:Button ID="addBookBtn" runat="server" Text="Register Booking" OnClick="addBookBtn_Click" />
                </td>
            </tr>
            <tr>
                <td class="auto-style3" style="width: 294px"><strong>Date of Birth</strong><br />
