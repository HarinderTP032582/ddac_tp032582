<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfantPassengerDetails.ascx.cs" Inherits="UIA_WebApp.InfantPassengerDetails" EnableViewState="false" %>
<style type="text/css">
    .auto-style1 {
        height: 23px;
        text-align: left;
    ...
    <tr>
        <td class="auto-style1" colspan="3">
            <h3 class="auto-style2">
                <asp:Label ID="InfantNoLabel1" runat="server" Text="Type #"></asp:Label></h3>
        </td>
    </tr>
    <tr>
