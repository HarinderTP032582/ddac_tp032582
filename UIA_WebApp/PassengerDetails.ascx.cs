...
{
    public partial class PassengerDetails : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            NoLabel1.Text = Request.Form[NoLabel1.UniqueID];
            ...
            if(Session["Passenger_Adult"].ToString() != null)
            {
                NoLabel1.Text = Session["Adult_Label"].ToString();
                i++;
            }
        }
        ...
        protected void addBookBtn_Click(object sender, EventArgs e)
        {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                        ...
                        "values(@passID, @passType, @title, @firstname, @lastname, @dob, @passportNo, @gender, @passportcountry, @passportexpiry)"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            ...
                            cmd.Parameters.AddWithValue("@passType", Session["Passenger_Adult"].ToString());
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "Alert", "alert(The " + this.NoLabel1.Text + " is successfully registered!);", true);
        }
    }
}